...
begin
    ...
    casez ({Page2, Page3, inst}) // Note pattern for the matching below
        10'b1010??0011:         // 1083, 1093, 10A3, 10B3 CMPD 
            srcreg =  ALU16_REG_D;
        10'b1010??1100:         // 108C, 109C, 10AC, 10BC CMPY
            srcreg =  ALU16_REG_Y;
        10'b0110??0011:         // 1183, 1193, 11A3, 11B3 CMPU
            srcreg =  ALU16_REG_U;
        10'b0110??1100:         // 118C, 119C, 11AC, 11BC CMPS
            srcreg =  ALU16_REG_S;
        10'b0010??1100:         // 8C,9C,AC,BC CMPX
            srcreg =  ALU16_REG_X;
        
        10'b0011??0011:         // C3, D3, E3, F3 ADDD
            srcreg =  ALU16_REG_D;
        
        10'b0011??1100:         // CC, DC, EC, FC LDD
            srcreg =  ALU16_REG_D;            
        10'b0010??1110:         // 8E LDX, 9E LDX, AE LDX, BE LDX
            srcreg =  ALU16_REG_X;
        10'b0011??1110:         // CE LDU, DE LDU, EE LDU, FE LDU
            srcreg =  ALU16_REG_U;        
        10'b1010??1110:         // 108E LDY, 109E LDY, 10AE LDY, 10BE LDY
            srcreg =  ALU16_REG_Y;
        10'b1011??1110:         // 10CE LDS, 10DE LDS, 10EE LDS, 10FE LDS
            srcreg =  ALU16_REG_S;               
        10'b0010??0011:         // 83, 93, A3, B3 SUBD
            srcreg =  ALU16_REG_D;
...
begin
    ...
    casez ({Page2, Page3, inst})
        ...
        10'b0011??1100:         // CC, DC, EC, FC LDD
            aluop  =  ALUOP16_LD;                
        10'b001???1110:         // 8E LDX, 9E LDX, AE LDX, BE LDX, CE LDU, DE LDU, EE LDU, FE LDU
            aluop  =  ALUOP16_LD;
        10'b101???1110:         // 108E LDY, 109E LDY, 10AE LDY, 10BE LDY, 10CE LDS, 10DE LDS, 10EE LDS, 10FE LDS
            aluop  =  ALUOP16_LD;
        ...
        10'b00001100??:         // $30-$33, LEAX, LEAY, LEAS, LEAU
            aluop  =  ALUOP16_LEA;
...
begin
    ...
    case (operation)
        ...
        ALUOP_ADC:
        begin
            {cc_out[CC_C_BIT], ALUFn[7:0]} =  {1'b0, a_arg} + {1'b0, b_arg} + { 8'h00, cc_arg[CC_C_BIT] };
            cc_out[CC_V_BIT]   =  (a_arg[7] & b_arg[7] & ~ALUFn[7]) | (~a_arg[7] & ~b_arg[7] & ALUFn[7]);
            cc_out[CC_H_BIT]   =  a_arg[4] ^ b_arg[4] ^ ALUFn[4];
        end
